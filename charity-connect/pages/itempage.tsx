  ...
  */
  ...
  return (
    ...
    <div className="border border-red-500">
      ...
      <div className="pt-24 md:grid grid-cols-7 border border-red-500">
        ...
        <div className="space-y-2 col-span-2 bg-[#01002e] z-10 shadow-sm p-5 border border-red-500">
          ...
          <div className="bg-[#01002e] z-10 shadow-sm text-xl border-[red]">
