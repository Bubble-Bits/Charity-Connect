        ...
        <div className=" flex items-center ">
          ...
          <div className="flex flex-col p-4 w-3/5">
            <h3 className="text-black text-s">
              Find local donation opportunities in your area! Discover nearby
              places to contribute and support charitable causes. Explore
              options for giving back and making a positive impact in your
              community. Locate donation centers and organizations that are
