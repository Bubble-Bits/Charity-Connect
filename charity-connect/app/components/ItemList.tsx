...
export default function ItemList() {
  ...
  return (
    <div>
      <div className="Filters flex mt-20px md:gap-4 md:ml-48 inline-block justify-center">
        <div className="FilterCategory m-5">
          ...
          {activeFilter === "Category" && (
            <div className="FilterCategory absolute bg-white border border-solid border-black rounded py-2 px-4">
