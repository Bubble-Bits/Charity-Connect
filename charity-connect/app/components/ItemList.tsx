...
<<<<<<< HEAD
        ...
        //--------------USE VARIABLE BELOW FOR STATIC DATA------------------------------//
        // let data = [
        //   {
...
>>>>>>> 9116192 (Committing before spulling)
        console.log(data);
        setItems(data);
      } catch (error) {
        console.log(error);
...
<<<<<<< HEAD
    <div>
      <div className="Filters flex mt-20px md:gap-4 md:ml-48 inline-block justify-center md:mr-32">
=======
    <>
