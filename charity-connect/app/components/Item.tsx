...
export default function Item(props: ItemProps) {
  ...
  return (
    <div className="p-2 w-full md:w-full lg:w-full xl:w-full m-1 h-[300px] hover:opacity-50 bg-[#ffffff] shadow-lg shadow-green-500/70 rounded">
      <div className="w-full h-2/3 overflow-hidden">
        <Image
          src={photos[0]}
          alt="Image of the donated item"
          width={500}
          height={500}
          className="rounded"
        />
